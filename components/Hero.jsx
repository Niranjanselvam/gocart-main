                ...
                <div className='relative flex-1 flex flex-col bg-green-200 rounded-3xl xl:min-h-100 group'>
                    <div className='p-5 sm:p-16'>
                        <div className='inline-flex items-center gap-3 bg-amber-100 text-amber-700 pr-4 p-1 rounded-full text-xs sm:text-sm'>
                                <span className='bg-amber-500 px-3 py-1 max-sm:ml-1 rounded-full text-white text-xs'>NEW</span> Free shipping on orders above ₹2,499 <ChevronRightIcon className='group-hover:ml-2 transition-all' size={16} />
                            </div>
                            <h2 className='text-3xl sm:text-5xl leading-[1.2] my-3 font-semibold bg-gradient-to-r from-slate-800 to-[#F97316] bg-clip-text text-transparent max-w-xs sm:max-w-md'>
                                HeartyHome: Stylish living, smart shopping.
                            </h2>
                            <div className='text-slate-900 text-sm font-medium mt-4 sm:mt-8'>
                                <p>Start decorating with</p>
                                <p className='text-3xl'>{currency}149</p>
                            </div>
