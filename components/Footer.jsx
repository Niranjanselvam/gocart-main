    ...
    const linkSections = [
        ...
        },
        {
            ...
            links: [
                ...
                { text: "Best Deals", path: '/best-products', icon: null },
                { text: "Discounts", path: '/discounts', icon: null },
            ]
        },
        {
            title: "CONTACT",
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm">HeartyHome brings Indian home essentials to your door with joyful deals, quality service, and a warm shopping experience.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2026 © heartyhome All Rights Reserved.
                </p>
            </div>
        </footer>
    );
