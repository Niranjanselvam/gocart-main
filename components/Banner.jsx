    ...
    return isOpen && (
        <div className="w-full px-6 py-1 font-medium text-sm text-white text-center bg-gradient-to-r from-violet-500 via-[#9938CA] to-[#E0724A]">
            <div className='flex flex-col sm:flex-row items-center justify-between max-w-7xl mx-auto gap-4'>
                <p>Enjoy 20% OFF on Indian home essentials today!</p>
                <div className="flex flex-wrap items-center gap-3 justify-center sm:justify-end">
                    <button onClick={handleClaim} type="button" className="font-normal text-gray-800 bg-white px-6 py-2 rounded-full">Copy Coupon</button>
